...
import com.lab8.EntityManager.ChartsEntityMethods;
...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        ChartsEntityMethods chartsEntityMethods = new ChartsEntityMethods();
        chartsEntityMethods.insertDatabase(moviesEntity);
    }
}
